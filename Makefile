# ====================================================================================
# Setup Project
PROJECT_NAME := provider-ankatest
...
XPKGS = provider-ankatest
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-ankatest: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider AnkaTest CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider AnkaTest controllers
...
# This target prepares repo for your provider by replacing all "ankatest"
